...
function MassageVenues() {
  ...
  const fetchListings = async () => {
    try {
      ...
      var data = null;
      var filter = {status:'Active',category:'Female Therapist'}
    ...
    >
      <div className="w-full flex flex-col gap-3 md:gap-6">
        ...
        <div className="fs-18-400-lato lh-27 txt-color-gray700 text-left text-center">
          Any supporting sub-heading if possible for explanation & SEO purposes.
        </div>
      </div>
